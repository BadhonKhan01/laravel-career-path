                ...
                <div class="hidden sm:block">
                  <div class="flex space-x-4">
                    ...
                    <a
                      ...
                      class="text-white rounded-md py-2 px-3 text-sm font-medium <?php echo ($_SERVER['REQUEST_URI'] == '/customer/dashboard') ? 'bg-emerald-700' :'' ?>"
                      aria-current="page"
                      >Dashboard</a
                    >
                    <a
                      href="/customer/deposit"
                      class="text-white hover:bg-emerald-500 hover:bg-opacity-75 rounded-md py-2 px-3 text-sm font-medium <?php echo ($_SERVER['REQUEST_URI'] == '/customer/deposit') ? 'bg-emerald-700' :'' ?>"
                      >Deposit</a
                    >
                    <a
                      href="/customer/withdraw"
                      class="text-white hover:bg-emerald-500 hover:bg-opacity-75 rounded-md py-2 px-3 text-sm font-medium <?php echo ($_SERVER['REQUEST_URI'] == '/customer/withdraw') ? 'bg-emerald-700' :'' ?>"
                      >Withdraw</a
                    >
                    <a
                      href="/customer/transfer"
                      class="text-white hover:bg-emerald-500 hover:bg-opacity-75 rounded-md py-2 px-3 text-sm font-medium <?php echo ($_SERVER['REQUEST_URI'] == '/customer/transfer') ? 'bg-emerald-700' :'' ?>"
                      >Transfer</a
                    >
                  </div>
                </div>
